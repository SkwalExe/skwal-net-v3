<template>
    <header :class="`${navOpened ? 'h-full' : ''} border-b-accent/80 border-b md:h-auto select-none flex fixed w-full top-0 items-center bg-primary/70 justify-center z-50 mb-5 shadow backdrop-blur-md`">
        <nav class="flex flex-col md:flex-row justify-center items-center px-5 py-4 w-full max-w-6xl h-full">
            <div class="w-full flex justify-between">
                <p class="text-4xl bg-clip-text text-transparent bg-gradient-to-r from-accent/40 via-accent/80 to-accent font-poppins font-semibold">Skwal</p>
